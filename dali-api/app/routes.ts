...
export default [
  ...
  layout("routes/layout.tsx", [
    ...
    route("help/timesheet", "routes/help.timesheet.tsx"),
    route("help/projects", "routes/help.projects.tsx"),
    route("help/documents", "routes/help.documents.tsx"),
  ...
  route("api/tour/progress", "routes/api.tour.progress.ts"),
