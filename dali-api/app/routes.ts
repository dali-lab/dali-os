...
export default [
  ...
  layout("routes/layout.tsx", [
    ...
    // Global interactive lab graph — every entity type, force-directed,
    // draggable/pannable/zoomable (Obsidian-style). Member-gated.
    route("graph", "graph/routes/graph.tsx"),
