...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  return { user: auth.user, photoUrl, hasCalendarLink, shouldShowTour, isCore: core, isAdmin: admin, isDomainLead: domainLead, isInstructor: instructor, canViewForms, canViewStaffing, isInterviewer, hasHiringAccess, isEmbedded }
}

export default function AppLayoutRoute() {
  const { user, photoUrl, hasCalendarLink, shouldShowTour, isCore, isAdmin, isDomainLead, isInstructor, canViewForms, canViewStaffing, isInterviewer, hasHiringAccess, isEmbedded } = useLoaderData<typeof loader>()
  ...
  return (
    <>
      <Layout user={user} photoUrl={photoUrl} isCore={isCore} isAdmin={isAdmin} isDomainLead={isDomainLead} isInstructor={isInstructor} canViewForms={canViewForms} canViewStaffing={canViewStaffing} isInterviewer={isInterviewer} hasHiringAccess={hasHiringAccess} />
