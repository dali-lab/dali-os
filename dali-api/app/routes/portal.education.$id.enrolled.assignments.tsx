...
import type { Route } from "./+types/portal.education.$id.enrolled.assignments";
...
export default function PortalEnrolledAssignments() {
      ...
      {assignments.length === 0 ? (
        ...
        <ul className="space-y-2">
          {assignments.map((a) => (
            <li key={a.id}>
              <Link
                to={`/portal/education/${offeringId}/assignments/${a.id}`}
