...
//   intent=update  → persist the detected/chosen zone to User.timeZone (the
//                    single display zone, shared by the calendar). Used both for
//                    the silent first-visit auto-detect and the "Update" button.
