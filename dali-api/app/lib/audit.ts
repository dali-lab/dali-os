...
export const AUDIT_ACTIONS = [
  ...
  "education.questions.replace",
  "education.questions.duplicate",
  "education.application.submit",
  "education.application.decision",
  "education.announcement.create",
  "education.instructor.add",
  "education.instructor.remove",
  ...
  "education.template.create",
  "education.template.update",
  "education.template.delete",
  "education.template.apply",
  "education.waitlist.reorder",
  "education.session.calendar_push",
  "education.assignment.instructions_doc",
] as const;
