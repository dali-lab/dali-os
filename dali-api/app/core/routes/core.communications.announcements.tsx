// Core-namespaced announcements.
//
// PURE RE-EXPORT of ~/admin/routes/admin.announcements — there is exactly one implementation and this
...
export { meta, loader, action, default } from "~/admin/routes/admin.announcements";

export const handle = coreHandle("announcements");
