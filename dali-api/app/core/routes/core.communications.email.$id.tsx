// Core-namespaced email template detail.
//
// PURE RE-EXPORT of ~/admin/routes/admin.email-templates.$id — there is exactly one implementation and this
...
export { meta, loader, action, default } from "~/admin/routes/admin.email-templates.$id";
