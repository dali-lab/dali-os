// Core-namespaced Intent to Work submissions.
//
// PURE RE-EXPORT of ~/projects/routes/projects.intent-to-work — there is exactly one implementation and this
...
export { meta, loader, action, default } from "~/projects/routes/projects.intent-to-work";
