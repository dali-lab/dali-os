// Core-namespaced Project Bids submissions.
//
// PURE RE-EXPORT of ~/projects/routes/projects.project-bids — there is exactly one implementation and this
...
export { meta, loader, action, default } from "~/projects/routes/projects.project-bids";
