...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  if (!on) return redirect("/partner/login");
...
export async function action({ request }: Route.ActionArgs) {
  ...
  // Split the full name and persist to the User row. Partners are not DALI
  // members — no netId, no dartmouthEmail, no DALIMember row. The partner
  // portal's onboarding guard handles PartnerContact/org provisioning.
