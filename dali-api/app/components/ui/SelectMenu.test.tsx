...
const opts: SelectMenuOption<string>[] = [
  { value: "a", label: "Apple" },
...
describe("SelectMenu", () => {
  it("renders a hidden native <select name> carrying the value for <Form> submission", () => {
    mount(createElement(SelectMenu, { name: "fruit", defaultValue: "b", options: opts, ariaLabel: "Fruit" }));
  ...
  it("omits the hidden native select when no name is given (pure controlled)", () => {
    mount(createElement(SelectMenu, { value: "a", options: opts, onChange: () => {}, ariaLabel: "Fruit" }));
  ...
  it("shows the placeholder when nothing is selected", () => {
    mount(createElement(SelectMenu, { name: "fruit", options: opts, placeholder: "Pick one", ariaLabel: "Fruit" }));
    const trigger = container.querySelector("button[aria-haspopup='listbox']");
