...
async function main() {
  ...
  // ── Partner Orgs + Projects ────────────────────────────────────────────────
  console.log("Seeding partner orgs and projects…");
  ...
  const partnerSeed: Array<{
    ...
    users: Array<{ id: string; name: string; email: string; displayRole?: string }>;
  }> = [
    {
      id: "partner-hop",
      name: "Hopkins Center for the Arts",
      website: "https://hop.dartmouth.edu",
      users: [
        { id: "puser-hop-1", name: "Margaret Lawrence", email: "margaret@hop.dartmouth.edu", displayRole: "Director of Programming" },
        { id: "puser-hop-2", name: "Daniel Cho", email: "daniel.cho@hop.dartmouth.edu", displayRole: "Marketing Lead" },
      ],
    },
    {
      id: "partner-rauner",
      name: "Rauner Special Collections Library",
      website: "https://www.dartmouth.edu/library/rauner",
      users: [
        { id: "puser-rauner-1", name: "Jay Satterfield", email: "jay.satterfield@dartmouth.edu", displayRole: "Special Collections Librarian" },
      ],
    },
    {
      id: "partner-thayer",
      name: "Thayer School of Engineering",
      website: "https://engineering.dartmouth.edu",
      users: [
        { id: "puser-thayer-1", name: "Priya Raman", email: "priya.raman@thayer.dartmouth.edu", displayRole: "Research Coordinator" },
        { id: "puser-thayer-2", name: "Marcus Webb", email: "marcus.webb@thayer.dartmouth.edu", displayRole: "Faculty Sponsor" },
      ],
    },
    {
      id: "partner-tuck",
      ...
      users: [
        { id: "puser-tuck-1", name: "Elena Ortiz", email: "elena.ortiz@tuck.dartmouth.edu", displayRole: "Associate Dean" },
      ],
    },
    {
      id: "partner-hood",
      ...
      users: [
        { id: "puser-hood-1", name: "Sarah Kim", email: "sarah.kim@hoodmuseum.dartmouth.edu", displayRole: "Curator" },
      ],
    },
    {
      id: "partner-dhmc",
      ...
      users: [
        { id: "puser-dhmc-1", name: "Dr. Aaron Patel", email: "aaron.patel@hitchcock.org", displayRole: "Innovation Lead" },
        { id: "puser-dhmc-2", name: "Nora Reilly", email: "nora.reilly@hitchcock.org", displayRole: "Product Manager" },
      ],
    },
    {
      id: "partner-magnusmode",
      name: "MagnusMode",
      website: "https://magnusmode.com",
      users: [
        { id: "puser-magnusmode-1", name: "Nadia Hassan", email: "nadia@magnusmode.com", displayRole: "CEO" },
      ],
    },
    {
      id: "partner-indie-aron",
      name: "Aron Lyman",
      isIndividual: true,
      users: [
        { id: "puser-indie-aron-1", name: "Aron Lyman", email: "aron@lyman.studio", displayRole: "Founder" },
      ],
    },
  ];
  ...
  for (const p of partnerSeed) {
    ...
    // Designate first user as primary contact.
    const firstUser = await prisma.partnerUser.findUnique({ where: { email: p.users[0].email } });
    if (firstUser) {
      await prisma.partnerOrg.update({
        where: { id: p.id },
        data: { primaryContactId: firstUser.id },
      });
    }
  }
  ...
  const projectSeed: Array<{
    ...
    {
      id: "project-hop-discovery",
      name: "Hop Discovery",
      status: "Active",
      calendarEmail: "hop-discovery@dali.dartmouth.edu",
      partnerIds: ["partner-hop"],
    },
    {
      id: "project-rauner-archive",
      name: "Rauner Digital Archive",
      status: "Active",
      calendarEmail: "rauner-archive@dali.dartmouth.edu",
      partnerIds: ["partner-rauner"],
    },
    {
      id: "project-thayer-lab-portal",
      name: "Thayer Lab Portal",
      status: "Active",
      calendarEmail: "thayer-portal@dali.dartmouth.edu",
      partnerIds: ["partner-thayer"],
    },
    {
      id: "project-tuck-mentor-match",
      name: "Tuck Mentor Match",
      status: "Active",
      calendarEmail: "tuck-mentor-match@dali.dartmouth.edu",
      partnerIds: ["partner-tuck", "partner-thayer"],
    },
    {
      id: "project-hood-explore",
      name: "Hood Explore",
      status: "Paused",
      calendarEmail: "hood-explore@dali.dartmouth.edu",
      partnerIds: ["partner-hood"],
    },
    {
      id: "project-dhmc-rounds",
      name: "DHMC Rounds Assistant",
      status: "Active",
      calendarEmail: "dhmc-rounds@dali.dartmouth.edu",
      partnerIds: ["partner-dhmc"],
    },
    {
      id: "project-magnusmode-companion",
      name: "MagnusCards Companion",
      status: "Active",
      calendarEmail: "magnus-companion@dali.dartmouth.edu",
      partnerIds: ["partner-magnusmode"],
    },
    {
      id: "project-indie-lyman-studio",
      name: "Lyman Studio Brand Site",
      status: "Archived",
      partnerIds: ["partner-indie-aron"],
    },
    {
      id: "project-dali-os",
      name: "DALI OS",
      status: "Active",
      calendarEmail: "dali-os@dali.dartmouth.edu",
      partnerIds: [],
    },
    {
      id: "project-dali-website",
      name: "DALI Website",
      status: "Active",
      calendarEmail: "dali-website@dali.dartmouth.edu",
      partnerIds: [],
    },
  ];

  for (const proj of projectSeed) {
    await prisma.project.upsert({
      where: { id: proj.id },
      update: {
        name: proj.name,
        status: proj.status,
        calendarEmail: proj.calendarEmail,
        firstTermId: currentTerm.id,
      },
      create: {
        id: proj.id,
        name: proj.name,
    ...
    for (const partnerOrgId of proj.partnerIds) {
      await prisma.projectPartner.upsert({
        where: { projectId_partnerOrgId: { projectId: proj.id, partnerOrgId } },
        update: {},
        create: {
          projectId: proj.id,
          partnerOrgId,
    ...
    // Mark project as continuing in the current term.
    await prisma.projectTermStatus.upsert({
      where: { projectId_termId: { projectId: proj.id, termId: currentTerm.id } },
      update: { isContinuing: proj.status === "Active" },
      create: {
        projectId: proj.id,
        termId: currentTerm.id,
        isContinuing: proj.status === "Active",
      },
    });
  }

  console.log(`  ${partnerSeed.length} partner orgs (${partnerSeed.reduce((n, p) => n + p.users.length, 0)} contacts) + ${projectSeed.length} projects seeded`);
}
